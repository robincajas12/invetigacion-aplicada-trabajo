...
Las **LSTM** fueron propuestas por Hochreiter y Schmidhuber en 1997 [@hochreiter1997lstm] para resolver el problema del desvanecimiento del gradiente. Una celda LSTM utiliza tres compuertas (*gates*) para controlar el flujo de información:
