...
Se presentan los resultados empíricos cuantitativos de los 6 modelos entrenados sobre las 50,000 partidas de Clash Royale en CPU, analizando sus desviaciones respecto al comportamiento real histórico del metajuego.
...
1. **Liderazgo de LSTM (MAE: 0.006103):** La red neuronal recurrente LSTM obtiene el ajuste más suave y preciso respecto a la línea real (*ground truth*). Sus compuertas de memoria interna permiten retener las inercias acumulativas de adopción de arquetipos a lo largo de las semanas (como el crecimiento sostenido de los mazos de *Ciclo Rápido*).
