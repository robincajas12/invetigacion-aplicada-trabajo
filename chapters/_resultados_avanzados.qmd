...
*Fuente:* Elaboración propia a partir del análisis del conjunto de datos de 50,000 partidas (2023-2026).

![Distribución de Rareza de Cartas en Mazos Ganadores vs. Perdedores](chapters/images/rarezas_ganadoras.png){#fig-rarezas fig-align="center" width=75%}

**Figura 6.1:** Distribución comparativa del número promedio de cartas por categoría de rareza en mazos ganadores frente a mazos perdedores.  
*Fuente:* Elaboración propia a partir del análisis del conjunto de datos histórico (2023-2026).
...
*Fuente:* Elaboración propia basada en el análisis de pares de cartas con al menos 150 batallas en el conjunto de datos (2023-2026).

![Top Sinergias y Combos de Cartas por Win Rate](chapters/images/sinergias_combos.png){#fig-sinergias fig-align="center" width=75%}

**Figura 6.2:** Porcentaje de victoria (Win Rate %) alcanzado por los combos de dos cartas con mayor efectividad en partidas competitivas.  
*Fuente:* Elaboración propia basada en la minería de patrones de combinación de cartas (2023-2026).
...
*Fuente:* Clasificador Random Forest (100 estimadores) entrenado sobre diferencias relativas entre jugadores (Elaboración propia).

![Importancia de Características para Clasificación de la Victoria](chapters/images/features_importance.png){#fig-importancia-variables fig-align="center" width=75%}

**Figura 6.3:** Ranking de importancia de características (*Feature Importance*) obtenido mediante el modelo Random Forest para clasificar al ganador.  
*Fuente:* Modelo Random Forest clasificador de 100 estimadores (Elaboración propia).
...
*Fuente:* Elaboración propia basada en la agrupación de coeficientes de importancia de Random Forest.
...
*Fuente:* Cálculo estadístico propio mediante la prueba t de Welch para muestras independientes.
